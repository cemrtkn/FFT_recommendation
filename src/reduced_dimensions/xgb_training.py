...
# Fine-tune and fit
# loo validation
#train_model(x_train, y_train, 'xgb', x_val=x_val, y_val=y_val, param_grid = param_grid)
# kfold
#model = train_model(x_train, y_train, 'xgb', param_grid = param_grid, folds=5)

# non-augmented loo validation
#best_params = {'eta': 0.51, 'alpha': 6}
# kfold
best_params = {'alpha': 4, 'eta': 0.21000000000000002}
